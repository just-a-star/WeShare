                ...
                <div class="flex items-center shrink-0">
                    <a href="{{ route('dashboard') }}" wire:navigate>
                        <div class="flex justify-center">
                            <p class="px-2 py-2 font-semibold text-center text-sky-950 dark:text-gray-300">WeShare
                            </p>
                            <x-application-logo
                                class="block w-auto h-10 text-gray-800 fill-current dark:text-gray-200" />
